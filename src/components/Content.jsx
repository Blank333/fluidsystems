...
import awardRec from "../assets/2.png";
import achieve from "../assets/3.png";

function Content() {
  return (
    <main>
      <div className='award'>
        <img src={award} alt='award' className='awardImg' />
        <div className='awardDesc'>
          ...
          <img src={awardRec} alt='Receiving award' className='awardImgRec' />
      ...
      <div className='achieve'>
        ...
        <img src={achieve} alt='Fluid components' className='achieveImg' />
